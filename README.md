...
I can not "flip a switch" and undo 20+ years of muscle memory expecting to find "escape" where everyone else has "caplock" (why do they need to shout so much?), where "set -o vi" isn't DEFAULT behaviour of bash (but you can't even get there because escape is already gone), every console and X default is for marketing specs and maximim resolution, resulting in the tiniest of text that humans can't possible agree is "easily readable," every program has keymaps so diverse that simple copy/paste is a puzzle to figure out "what's going to work this time," it goes on and on, complete madness, and no matter "how pretty" the new installer is, there is some reverse logic click here choice that is counter intuitive almost as though to make sure you are confused and can't be on autopilot with your natural fast productive workflow. Every point that could be simple, grows more "pretty" but complex, fragmented by opinionated implementations, and generally confusing. I don't have time for that nonesense, I don't even have time to take my fingers off the keyboard and reach for a mouse... I don't want to be part of that world. So, without being a programmer, just a "hack," I'm going to make my own installer, maybe, if I'm lucky. Opinionated I guess, I just think of it as "functional."
